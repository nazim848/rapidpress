			...
			<tr valign="top" id="rapidpress_js_delay_options" style="display: none;">
				...
				<td>
					<select name="rapidpress_js_delay_type" id="rapidpress_js_delay_type">
						<option value="all" <?php selected(get_option('rapidpress_js_delay_type'), 'all'); ?>>All JavaScript</option>
						<option value="specific" <?php selected(get_option('rapidpress_js_delay_type'), 'specific'); ?>>Specific JavaScript Files</option>
					</select>
					<div id="rapidpress_js_delay_specific" style="display: none;">
					...
					<div id="rapidpress_js_delay_all">
